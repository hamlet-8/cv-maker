...
const Template1 = ({
  ...
  <div className="yourresume__content-tamplate1">
    <div className="yourresume__contact-tamplate1">
    ...
    <div className="yourresume__second-block-tamplate1">
      <div className="yourresume__summary-tamplate1">
        <h3>Summary</h3>
        <span>{summarySummary}</span>
      </div>
      <div className="yourresume__skills-tamplate1">
        <h3>Skills</h3>
        <span>{skillsSkills}</span>
      </div>
      <div className="yourresume__experience-tamplate1">
        <h3>Experience</h3>
      ...
      <div className="yourresume__education-tamplate1">
        <h3>Education</h3>
